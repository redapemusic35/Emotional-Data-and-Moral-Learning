...
I have attempted to argue elsewhere in this project, that @stum10 has a similar treatment of mind reading according to which she argues that narratives provide a way to have what she calls "second personal knowledge." If Coplan is right, then using this understanding of second personal knowledge, as facilitated by narrative, it might be thought that empathy is a vehicle through which we can come to know others second personally, and that narratives provide a way in which we might come to know others empathically. 
...
hiphoplyrics2 <- read.csv("/home/redapemusic35/VimWiki/subjects/projects/lyrics/mycsv8.csv", header = TRUE, stringsAsFactors = FALSE)
...
hiphoplyrics$Content <- sapply(hiphoplyrics$Content, fix.contractions)
...
hiphoplyrics$Content <- sapply(hiphoplyrics$Content, fix.contractions)
hiphoplyrics$FileName <- sapply(hiphoplyrics$FileName, fix.contractions)
...
hiphopcontent <- hiphoplyrics$Content
hiphopname <- hiphoplyrics$FileName

lyrics_df <- tibble(name = 1:50, text = content)
lyrics2_df <- lyrics_df %>%
  unnest_tokens(word, text)

hiphoplyrics_df <- tibble(name = 1:50, text = hiphopcontent)
...
What I show here, are two distinct data frames. The first includes those words which are used most frequently in the top 50 country songs of the billboard country charts, taken May 23, 2020. Ignoring "ai" which shows to have been repeated 127 times in 50 sets of lyrics, the most frequent word used in these lyrics is "love" at 107 usage instance in 50 song lyrics. The next, "yeah" should likely be articulated as a "stop-word." Stop-words are words like "and," "the," "it," and are typically not thought as contributing to the content meaning in a data source.
